...
let BaseApiClient = class BaseApiClient {
    ...
    async callApi(options) {
        ...
        if (forceUser) {
            ...
            const accessToken = await authProvider.getAccessTokenForUser(options.userId, (0, shared_utils_1.mapOptional)(options.scope, scope => [scope]));
     ...
     */
    get lastKnownLimit() {
        if (this._rateLimiter instanceof HelixRateLimiter_1.HelixRateLimiter) {
...
tslib_1.__decorate([
    (0, cache_decorators_1.CachedGetter)()
], BaseApiClient.prototype, "unsupported", null);
