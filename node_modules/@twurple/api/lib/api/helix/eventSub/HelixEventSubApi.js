...
let HelixEventSubApi = class HelixEventSubApi extends BaseApi_1.BaseApi {
    ...
    async subscribeToChannelCharityCampaignStartEvents(broadcaster, transport) {
        return await this.createSubscription('channel.charity_campaign.start', 'beta', (0, eventSub_external_1.createEventSubBroadcasterCondition)(broadcaster), transport, 'channel:read:charity');
    }
    /**
    ...
    async subscribeToChannelCharityCampaignStopEvents(broadcaster, transport) {
        return await this.createSubscription('channel.charity_campaign.stop', 'beta', (0, eventSub_external_1.createEventSubBroadcasterCondition)(broadcaster), transport, 'channel:read:charity');
    }
    /**
    ...
    async subscribeToChannelCharityDonationEvents(broadcaster, transport) {
        return await this.createSubscription('channel.charity_campaign.donate', 'beta', (0, eventSub_external_1.createEventSubBroadcasterCondition)(broadcaster), transport, 'channel:read:charity');
    }
    /**
    ...
    async subscribeToChannelCharityCampaignProgressEvents(broadcaster, transport) {
        return await this.createSubscription('channel.charity_campaign.progress', 'beta', (0, eventSub_external_1.createEventSubBroadcasterCondition)(broadcaster), transport, 'channel:read:charity');
    }
    /**
    ...
    async subscribeToChannelShieldModeBeginEvents(broadcaster, moderator, transport) {
        return await this.createSubscription('channel.shield_mode.begin', 'beta', (0, eventSub_external_1.createEventSubModeratorCondition)(broadcaster, moderator), transport, 'moderator:read:shield_mode');
    }
    /**
    ...
    async subscribeToChannelShieldModeEndEvents(broadcaster, moderator, transport) {
        return await this.createSubscription('channel.shield_mode.end', 'beta', (0, eventSub_external_1.createEventSubModeratorCondition)(broadcaster, moderator), transport, 'moderator:read:shield_mode');
    }
    /**
