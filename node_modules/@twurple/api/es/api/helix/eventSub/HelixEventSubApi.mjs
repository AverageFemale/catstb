...
let HelixEventSubApi = class HelixEventSubApi extends BaseApi {
    ...
    async subscribeToChannelCharityCampaignStartEvents(broadcaster, transport) {
        return await this.createSubscription('channel.charity_campaign.start', 'beta', createEventSubBroadcasterCondition(broadcaster), transport, 'channel:read:charity');
    }
    /**
    ...
    async subscribeToChannelCharityCampaignStopEvents(broadcaster, transport) {
        return await this.createSubscription('channel.charity_campaign.stop', 'beta', createEventSubBroadcasterCondition(broadcaster), transport, 'channel:read:charity');
    }
    /**
    ...
    async subscribeToChannelCharityDonationEvents(broadcaster, transport) {
        return await this.createSubscription('channel.charity_campaign.donate', 'beta', createEventSubBroadcasterCondition(broadcaster), transport, 'channel:read:charity');
    }
    /**
    ...
    async subscribeToChannelCharityCampaignProgressEvents(broadcaster, transport) {
        return await this.createSubscription('channel.charity_campaign.progress', 'beta', createEventSubBroadcasterCondition(broadcaster), transport, 'channel:read:charity');
    }
    /**
    ...
    async subscribeToChannelShieldModeBeginEvents(broadcaster, moderator, transport) {
        return await this.createSubscription('channel.shield_mode.begin', 'beta', createEventSubModeratorCondition(broadcaster, moderator), transport, 'moderator:read:shield_mode');
    }
    /**
    ...
    async subscribeToChannelShieldModeEndEvents(broadcaster, moderator, transport) {
        return await this.createSubscription('channel.shield_mode.end', 'beta', createEventSubModeratorCondition(broadcaster, moderator), transport, 'moderator:read:shield_mode');
    }
    /**
