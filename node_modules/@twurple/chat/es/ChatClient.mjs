...
let ChatClient = ChatClient_1 = class ChatClient extends IrcClient {
    ...
    constructor(config = {}) {
        ...
        const executeWhisperRequest = async ({ target, text }) => this._doWhisper(target, text);
    ...
    async host(channel, target) {
        this._chatLogger.warn(`Host ${target} in ${channel !== null && channel !== void 0 ? channel : this._credentials.nick}: hosting was removed by Twitch`);
    }
    /**
     * Does nothing, as Twitch removed the hosting feature on 2022-10-03.
     *
