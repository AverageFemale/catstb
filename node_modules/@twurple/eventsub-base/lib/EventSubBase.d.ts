...
import type { ApiClient, HelixEventSubSubscription, HelixEventSubTransportOptions, UserIdResolvable } from '@twurple/api';
...
export declare abstract class EventSubBase extends EventEmitter {
     ...
     * @param handler The function that will be called for any new notifications.
     */
    subscribeToChannelCharityCampaignStartEvents(user: UserIdResolvable, handler: (event: EventSubChannelCharityCampaignStartEvent) => void): Promise<EventSubSubscription>;
    /**
     ...
     * @param handler The function that will be called for any new notifications.
     */
    subscribeToChannelCharityCampaignStopEvents(user: UserIdResolvable, handler: (event: EventSubChannelCharityCampaignStopEvent) => void): Promise<EventSubSubscription>;
    /**
     ...
     * @param handler The function that will be called for any new notifications.
     */
    subscribeToChannelCharityDonationEvents(user: UserIdResolvable, handler: (event: EventSubChannelCharityDonationEvent) => void): Promise<EventSubSubscription>;
    /**
     ...
     * @param handler The function that will be called for any new notifications.
     */
    subscribeToChannelCharityCampaignProgressEvents(user: UserIdResolvable, handler: (event: EventSubChannelCharityCampaignProgressEvent) => void): Promise<EventSubSubscription>;
    /**
     ...
     * @beta
     */
    subscribeToChannelShieldModeBeginEvents(broadcaster: UserIdResolvable, moderator: UserIdResolvable, handler: (event: EventSubChannelShieldModeBeginEvent) => void): Promise<EventSubSubscription>;
    /**
     ...
     * @beta
     */
    subscribeToChannelShieldModeEndEvents(broadcaster: UserIdResolvable, moderator: UserIdResolvable, handler: (event: EventSubChannelShieldModeEndEvent) => void): Promise<EventSubSubscription>;
    /**
     ...
     * @param handler The function that will be called for any new notifications.
     */
    subscribeToUserAuthorizationGrantEvents(clientId: string, handler: (data: EventSubUserAuthorizationGrantEvent) => void): Promise<EventSubSubscription>;
    /**
